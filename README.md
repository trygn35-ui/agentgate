...
- “请求记录”显示当前请求与最近 100 条记录，包括首字/首包、Token、模型、推理强度和实时耗时；记录持久保存在本地 `requests.json`，新请求顶掉最旧记录，任何时候都不保存请求正文。
...
```text
Keydeck-Portable-0.7.3-x64.exe
Keydeck-Setup-0.7.3-x64.exe
Keydeck-0.7.3-source.zip
SHA256SUMS-0.7.3.txt
```
